...
class LiveNewsScreen extends GetView<HomeViewModel> {
  ...
  Widget build(BuildContext context) {
    ...
    controller
        .getEditorNews(controller.homeModel!.realtimeTrendNewsLetters[0].id);
                        ...
                        children: [
                          Container(
                            ...
                            child: Center(
                              child: Obx(
                                () => Text(
                                  controller.splitKeywords(
                                      controller.homeModel!
                                          .realtimeTrendNewsLetters[0].keywords,
                                      0),
                          ...
                          Padding(
                              ...
                              child: Obx(() => Text(
                                  controller.dateParsing(controller
                                      ...
                                      child: Align(
                                          ...
                                          child: Obx(() => Text(
                                                controller.splitParagraph(
                                                  controller.newsLetterModel?.summary ?? '해당하는 뉴스가 존재하지 않습니다.',
                                                  0,
                                                ),
                                                softWrap: true,
                            ...
                            ? ListView(
                                ...
                                children: [
                                    CommentWidget(
                                      ...
                                      perspective: controller.setPerspective(
                                          controller.isDialogAgreeList.value),
                                      onFollow: ElevatedButton(
                                        onPressed: () {
                                          if (controller.isFollowReal.value ==
                                              false) {
                                      ...
                                      onLike: GestureDetector(
                                        onTap: () {
                                          if (controller.isLikeReal.value ==
                                              false) {
                                        ...
                                        child: Row(
                                          children: [
                                            ...
                                            Text(
                                              controller.isLikeReal.value
                                                  ? '28'
                                                  : '27',
                                              style: FontStyles.Caption2_m
                                                  .copyWith(
                                                      color: AppColors.g3),
                                            ),
                                          ],
                                    ...
                                    CommentWidget(
                                      ...
                                      time: '1시간 전',
                                      content:
                                          '원격 근무가 생산성도 높이고 국가 경제에도 긍정적인 영향을 미칠 것이라 예상되는데, 한국에는 아직 제대로 자리잡히지 않은 것 같아요.',
                                      perspective: '잘 모르겠어요',
                                      onFollow: ElevatedButton(
                                        onPressed: () {
                                          if (controller.isFollowReal2.value ==
                                              false) {
                                        ...
                                        style: ElevatedButton.styleFrom(
                                          ...
                                          padding:
                                              EdgeInsetsDirectional.symmetric(
                                                  horizontal: 8, vertical: 2),
                                          backgroundColor:
                                              controller.isFollowReal2.value
                                                  ? AppColors.g2
                                                  : AppColors.g6,
                                          shape: RoundedRectangleBorder(
                                            borderRadius:
                                      ...
                                      onLike: GestureDetector(
                                        onTap: () {
                                          if (controller.isLikeReal2.value ==
                                              false) {
